...
select o.OrderID, c.Name as CustomerName, count(oi.Quantity) as NumberOfItems 
from Orders o join Customers c on c.CustomerID  = o.CustomerID 
join OrderItems oi on oi.OrderID = o.OrderID group by o.OrderID having NumberOfItems>1 order by c.Name
