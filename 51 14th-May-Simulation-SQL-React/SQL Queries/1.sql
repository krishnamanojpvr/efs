...
select c.Name, o.OrderID,o.TotalCost from Customers c join Orders o on c.CustomerID=o.CustomerID
where o.TotalCost > (select avg(ord.TotalCost) from Orders ord where ord.CustomerID=o.CustomerID);